# CODE BOOK for the 'tidy_data_set' data table. 
*** 
...
*** 
## Informations on 'tidy_data_set' data table  
...
### Description of the variables from 'tidy_data_set'
 
The following table describes all variables of the 'tidy_data_set' table. 
...
### How to load 'tidy_data_set' data in R 
 
In order to load the 'tidy_data_set' in R correctly,
...
This is the needed file to commplete the project: 
...
[Getting and Cleaning Data Course Project](https://github.com/coderforbd/Getting-and-Cleaning-Data-Course-Project). 
...
the following notes should be taken into account:
  ...
  - The data used for the download was accessed by the script
    '[project_data.R](https://github.com/coderforbd/Getting-and-Cleaning-Data-Course-Project/blob/master/project_data.R)', 
    from the url:
...
```
platform       x86_64-w64-windows10        
arch           x86_64                     
os             windows 10                 
system         x86_64, windows 10          
status                                    
major          4                          
minor          0.0                        
year           2020                       
...
*** 
## The process by which the 'tidy_data_set' table was produced  
...
The raw signal were produced, as it is explained in the 'README.txt' file of
original data set:
...
The 'tidy_data_set' table was created by using the following data set: 
