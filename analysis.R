...
#               - in RStudio Version 1.2.5042
#               - with R version 4.0.0 (2020-04-24)
...
#                                           comments.char = "", quote = "") 
#          
#           Details on the 'tidy_data_set' table can be found,
#           at 'CodeBook.md' that exist in the Git Hub, from the link:
#           "https://github.com/coderforbd/Getting-and-Cleaning-Data-Course-Project/blob/master/CodeBook.md"
#
...
## Replace the variable names of 'tidy_data_set' with new descriptive ones.
## Just the prefix "Avrg-" will be added in all variable names,
## except the first two, 'subject' and 'activity'.
new_names_for_summary <- c(names(tidy_data_set[c(1,2)]),
                           paste0("Avrg-", names(tidy_data_set[-c(1, 2)])))
names(tidy_data_set) <- new_names_for_summary
